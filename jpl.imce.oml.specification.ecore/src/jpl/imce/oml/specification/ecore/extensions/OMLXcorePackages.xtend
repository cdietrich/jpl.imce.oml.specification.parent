...
class OMLXcorePackages {
	...
	new() {
		...
		val omlc_uri = URI.createPlatformResourceURI("/jpl.imce.oml.specification.ecore"+omlc, false)
		val omlt = "/model/OMLTerminologies.xcore"
		val omlt_uri = URI.createPlatformResourceURI("/jpl.imce.oml.specification.ecore"+omlt, false)
		val omlg = "/model/OMLGraphs.xcore"
		val omlg_uri = URI.createPlatformResourceURI("/jpl.imce.oml.specification.ecore"+omlg, false)
