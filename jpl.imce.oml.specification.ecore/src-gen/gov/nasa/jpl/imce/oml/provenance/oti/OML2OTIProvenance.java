 ...
 * </ul>
 *
 * @see gov.nasa.jpl.imce.oml.provenance.oti.OMLPPackage#getOML2OTIProvenance()
 * @model
 * @generated
 */
public interface OML2OTIProvenance extends EObject {
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OMLPPackage#getOML2OTIProvenance_OmlUUID()
	 ...
	 * @see #setOtiID(String)
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OMLPPackage#getOML2OTIProvenance_OtiID()
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OMLPPackage#getOML2OTIProvenance_OtiURL()
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OMLPPackage#getOML2OTIProvenance_OtiUUID()
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OMLPPackage#getOML2OTIProvenance_Explanation()
