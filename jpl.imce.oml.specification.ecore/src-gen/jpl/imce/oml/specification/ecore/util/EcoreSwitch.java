...
public class EcoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EcorePackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EcorePackage.TERMINOLOGY_THING: {
			...
			case EcorePackage.ANNOTATION_PROPERTY_TABLE: {
			...
			case EcorePackage.ANNOTATION_SUBJECT_PROPERTY_VALUE: {
			...
			case EcorePackage.TERMINOLOGY_BOX: {
			...
			case EcorePackage.TERMINOLOGY_BOX_STATEMENT: {
			...
			case EcorePackage.TERMINOLOGY_BUNDLE_STATEMENT: {
			...
			case EcorePackage.CONCEPTUAL_ENTITY: {
			...
			case EcorePackage.ENTITY_RELATIONSHIP: {
			...
			case EcorePackage.DATA_RELATIONSHIP: {
			...
			case EcorePackage.DATA_RELATIONSHIP_DOMAIN: {
			...
			case EcorePackage.DATA_RELATIONSHIP_FROM_ENTITY: {
			...
			case EcorePackage.DATA_RELATIONSHIP_FROM_STRUCTURE: {
			...
			case EcorePackage.DATA_RELATIONSHIP_RANGE: {
			...
			case EcorePackage.DATA_RELATIONSHIP_TO_SCALAR: {
			...
			case EcorePackage.DATA_RELATIONSHIP_TO_STRUCTURE: {
			...
			case EcorePackage.TERMINOLOGY_AXIOM: {
			...
			case EcorePackage.TERMINOLOGY_BOX_AXIOM: {
			...
			case EcorePackage.TERMINOLOGY_BUNDLE_AXIOM: {
			...
			case EcorePackage.CONCEPT_TREE_DISJUNCTION: {
			...
			case EcorePackage.DISJOINT_UNION_OF_CONCEPTS_AXIOM: {
			...
			case EcorePackage.ENTITY_RESTRICTION_AXIOM: {
			...
			case EcorePackage.SPECIALIZATION_AXIOM: {
			...
			case EcorePackage.ENTITY_SCALAR_DATA_PROPERTY_RESTRICTION_AXIOM: {
			...
			case EcorePackage.RESTRICTED_DATA_RANGE: {
			...
			case EcorePackage.DESCRIPTION_BOX_RELATIONSHIP: {
			...
			case EcorePackage.TERMINOLOGY_INSTANCE_ASSERTION: {
			...
			case EcorePackage.SINGLETON_INSTANCE: {
			...
			case EcorePackage.CONCEPTUAL_ENTITY_SINGLETON_INSTANCE: {
