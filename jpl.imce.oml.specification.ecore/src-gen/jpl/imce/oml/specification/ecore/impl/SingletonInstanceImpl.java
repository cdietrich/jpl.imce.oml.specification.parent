...
public abstract class SingletonInstanceImpl extends TerminologyInstanceAssertionImpl implements SingletonInstance {
	...
	protected EClass eStaticClass() {
		return EcorePackage.eINSTANCE.getSingletonInstance();
	}
	...
	public EList<ScalarDataPropertyValue> getScalarDataPropertyValues() {
		if (scalarDataPropertyValues == null) {
			scalarDataPropertyValues = new EObjectContainmentWithInverseEList<ScalarDataPropertyValue>(ScalarDataPropertyValue.class, this, EcorePackage.SINGLETON_INSTANCE__SCALAR_DATA_PROPERTY_VALUES, EcorePackage.SCALAR_DATA_PROPERTY_VALUE__SINGLETON_INSTANCE);
		}
	...
	public EList<StructuredDataPropertyValue> getStructuredDataPropertyValues() {
		if (structuredDataPropertyValues == null) {
			structuredDataPropertyValues = new EObjectContainmentWithInverseEList<StructuredDataPropertyValue>(StructuredDataPropertyValue.class, this, EcorePackage.SINGLETON_INSTANCE__STRUCTURED_DATA_PROPERTY_VALUES, EcorePackage.STRUCTURED_DATA_PROPERTY_VALUE__SINGLETON_INSTANCE);
		}
