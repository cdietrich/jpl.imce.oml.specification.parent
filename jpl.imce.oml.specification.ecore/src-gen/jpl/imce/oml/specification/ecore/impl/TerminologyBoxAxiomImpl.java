...
public abstract class TerminologyBoxAxiomImpl extends TerminologyAxiomImpl implements TerminologyBoxAxiom {
	...
	protected EClass eStaticClass() {
		return EcorePackage.eINSTANCE.getTerminologyBoxAxiom();
	}
	...
	public TerminologyBox getTbox() {
		if (eContainerFeatureID() != EcorePackage.TERMINOLOGY_BOX_AXIOM__TBOX) return null;
	...
	public NotificationChain basicSetTbox(TerminologyBox newTbox, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTbox, EcorePackage.TERMINOLOGY_BOX_AXIOM__TBOX, msgs);
		return msgs;
	}
	...
	public void setTbox(TerminologyBox newTbox) {
		if (newTbox != eInternalContainer() || (eContainerFeatureID() != EcorePackage.TERMINOLOGY_BOX_AXIOM__TBOX && newTbox != null)) {
			...
			if (newTbox != null)
				msgs = ((InternalEObject)newTbox).eInverseAdd(this, EcorePackage.TERMINOLOGY_BOX__TERMINOLOGY_BOX_AXIOMS, TerminologyBox.class, msgs);
			msgs = basicSetTbox(newTbox, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePackage.TERMINOLOGY_BOX_AXIOM__TBOX, newTbox, newTbox));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EcorePackage.TERMINOLOGY_BOX_AXIOM__TBOX:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case EcorePackage.TERMINOLOGY_BOX_AXIOM__TBOX:
				return eInternalContainer().eInverseRemove(this, EcorePackage.TERMINOLOGY_BOX__TERMINOLOGY_BOX_AXIOMS, TerminologyBox.class, msgs);
		}
