 ...
 * </p>
 * <ul>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.NumericScalarRestrictionImpl#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.NumericScalarRestrictionImpl#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.NumericScalarRestrictionImpl#getMinExclusive <em>Min Exclusive</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.NumericScalarRestrictionImpl#getMaxExclusive <em>Max Exclusive</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NumericScalarRestrictionImpl extends RestrictedDataRangeImpl implements NumericScalarRestriction {
	...
	public String calculateUUID() {
		String _xblockexpression = null;
		{
			...
			String _plus = ("NumericScalarRestriction(restrictedRange=" + _uuid);
