 ...
 * </p>
 * <ul>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsFunctional <em>Is Functional</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsInverseFunctional <em>Is Inverse Functional</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsEssential <em>Is Essential</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsInverseEssential <em>Is Inverse Essential</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsSymmetric <em>Is Symmetric</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsAsymmetric <em>Is Asymmetric</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsReflexive <em>Is Reflexive</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsIrreflexive <em>Is Irreflexive</em>}</li>
 *   <li>{@link jpl.imce.oml.specification.ecore.impl.EntityRelationshipImpl#isIsTransitive <em>Is Transitive</em>}</li>
 * </ul>
 *
 * @generated
 */
