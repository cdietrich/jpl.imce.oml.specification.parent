...
import gov.nasa.jpl.imce.oml.graphs.ScalarOneOfLiteralAxiom;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.graphs.ScalarOneOfLiteralAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScalarOneOfLiteralAxiomItemProvider extends AxiomItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.SCALAR_ONE_OF_LITERAL_AXIOM__AXIOM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.SCALAR_ONE_OF_LITERAL_AXIOM__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ScalarOneOfLiteralAxiom.class)) {
			case OMLGPackage.SCALAR_ONE_OF_LITERAL_AXIOM__VALUE:
