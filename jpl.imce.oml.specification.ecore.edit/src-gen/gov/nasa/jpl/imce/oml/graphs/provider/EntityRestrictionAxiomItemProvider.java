...
import gov.nasa.jpl.imce.oml.graphs.EntityRestrictionAxiom;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.graphs.EntityRestrictionAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityRestrictionAxiomItemProvider extends TermAxiomItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EntityRestrictionAxiomItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.ENTITY_RESTRICTION_AXIOM__RESTRICTED_RELATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.ENTITY_RESTRICTION_AXIOM__RESTRICTED_RANGE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Restricted Domain feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRestrictedDomainPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 ...
				 OMLGPackage.Literals.ENTITY_RESTRICTION_AXIOM__RESTRICTED_DOMAIN,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((EntityRestrictionAxiom)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_EntityRestrictionAxiom_type") :
			getString("_UI_EntityRestrictionAxiom_type") + " " + label;
	}
