...
import gov.nasa.jpl.imce.oml.graphs.NumericScalarRestriction;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.graphs.NumericScalarRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumericScalarRestrictionItemProvider extends RestrictedDataRangeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.NUMERIC_SCALAR_RESTRICTION__MIN_INCLUSIVE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.NUMERIC_SCALAR_RESTRICTION__MAX_INCLUSIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.NUMERIC_SCALAR_RESTRICTION__MIN_EXCLUSIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.NUMERIC_SCALAR_RESTRICTION__MAX_EXCLUSIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NumericScalarRestriction.class)) {
			case OMLGPackage.NUMERIC_SCALAR_RESTRICTION__MIN_INCLUSIVE:
			case OMLGPackage.NUMERIC_SCALAR_RESTRICTION__MAX_INCLUSIVE:
			case OMLGPackage.NUMERIC_SCALAR_RESTRICTION__MIN_EXCLUSIVE:
			case OMLGPackage.NUMERIC_SCALAR_RESTRICTION__MAX_EXCLUSIVE:
