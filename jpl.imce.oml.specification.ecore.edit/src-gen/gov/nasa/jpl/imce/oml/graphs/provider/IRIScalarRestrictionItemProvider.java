...
import gov.nasa.jpl.imce.oml.graphs.IRIScalarRestriction;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.graphs.IRIScalarRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IRIScalarRestrictionItemProvider extends RestrictedDataRangeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.IRI_SCALAR_RESTRICTION__LENGTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.IRI_SCALAR_RESTRICTION__MIN_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.IRI_SCALAR_RESTRICTION__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.IRI_SCALAR_RESTRICTION__PATTERN,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IRIScalarRestriction.class)) {
			case OMLGPackage.IRI_SCALAR_RESTRICTION__LENGTH:
			case OMLGPackage.IRI_SCALAR_RESTRICTION__MIN_LENGTH:
			case OMLGPackage.IRI_SCALAR_RESTRICTION__MAX_LENGTH:
			case OMLGPackage.IRI_SCALAR_RESTRICTION__PATTERN:
