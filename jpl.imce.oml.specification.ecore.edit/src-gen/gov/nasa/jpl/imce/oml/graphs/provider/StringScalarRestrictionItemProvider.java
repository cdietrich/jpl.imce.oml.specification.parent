...
import gov.nasa.jpl.imce.oml.graphs.StringScalarRestriction;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.graphs.StringScalarRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringScalarRestrictionItemProvider extends RestrictedDataRangeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.STRING_SCALAR_RESTRICTION__LENGTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.STRING_SCALAR_RESTRICTION__MIN_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.STRING_SCALAR_RESTRICTION__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLGPackage.Literals.STRING_SCALAR_RESTRICTION__PATTERN,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringScalarRestriction.class)) {
			case OMLGPackage.STRING_SCALAR_RESTRICTION__LENGTH:
			case OMLGPackage.STRING_SCALAR_RESTRICTION__MIN_LENGTH:
			case OMLGPackage.STRING_SCALAR_RESTRICTION__MAX_LENGTH:
			case OMLGPackage.STRING_SCALAR_RESTRICTION__PATTERN:
