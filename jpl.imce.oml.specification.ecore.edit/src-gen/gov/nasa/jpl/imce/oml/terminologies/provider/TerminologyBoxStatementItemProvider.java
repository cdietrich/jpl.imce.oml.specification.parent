...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.TerminologyBoxStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminologyBoxStatementItemProvider extends ModuleElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TerminologyBoxStatementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.TERMINOLOGY_BOX_STATEMENT__TBOX,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((TerminologyBoxStatement)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_TerminologyBoxStatement_type") :
			getString("_UI_TerminologyBoxStatement_type") + " " + label;
	}
