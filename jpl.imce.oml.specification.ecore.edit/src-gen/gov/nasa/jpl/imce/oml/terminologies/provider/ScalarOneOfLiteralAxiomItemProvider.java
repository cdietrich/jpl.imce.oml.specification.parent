...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.ScalarOneOfLiteralAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScalarOneOfLiteralAxiomItemProvider extends TermAxiomItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.SCALAR_ONE_OF_LITERAL_AXIOM__AXIOM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.SCALAR_ONE_OF_LITERAL_AXIOM__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ScalarOneOfLiteralAxiom.class)) {
			case OMLTPackage.SCALAR_ONE_OF_LITERAL_AXIOM__VALUE:
