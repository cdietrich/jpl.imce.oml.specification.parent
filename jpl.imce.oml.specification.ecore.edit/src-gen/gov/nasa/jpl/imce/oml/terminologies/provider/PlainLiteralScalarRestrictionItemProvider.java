...
import gov.nasa.jpl.imce.oml.terminologies.PlainLiteralScalarRestriction;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.PlainLiteralScalarRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlainLiteralScalarRestrictionItemProvider extends RestrictedDataRangeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.PLAIN_LITERAL_SCALAR_RESTRICTION__LENGTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.PLAIN_LITERAL_SCALAR_RESTRICTION__MIN_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.PLAIN_LITERAL_SCALAR_RESTRICTION__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.PLAIN_LITERAL_SCALAR_RESTRICTION__PATTERN,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.PLAIN_LITERAL_SCALAR_RESTRICTION__LANG_RANGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PlainLiteralScalarRestriction.class)) {
			case OMLTPackage.PLAIN_LITERAL_SCALAR_RESTRICTION__LENGTH:
			case OMLTPackage.PLAIN_LITERAL_SCALAR_RESTRICTION__MIN_LENGTH:
			case OMLTPackage.PLAIN_LITERAL_SCALAR_RESTRICTION__MAX_LENGTH:
			case OMLTPackage.PLAIN_LITERAL_SCALAR_RESTRICTION__PATTERN:
			case OMLTPackage.PLAIN_LITERAL_SCALAR_RESTRICTION__LANG_RANGE:
