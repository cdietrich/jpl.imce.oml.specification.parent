...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.EntityRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityRelationshipItemProvider extends TermItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_FUNCTIONAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_INVERSE_FUNCTIONAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_ESSENTIAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_INVERSE_ESSENTIAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_SYMMETRIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_ASYMMETRIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_REFLEXIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_IRREFLEXIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RELATIONSHIP__IS_TRANSITIVE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntityRelationship.class)) {
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_FUNCTIONAL:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_INVERSE_FUNCTIONAL:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_ESSENTIAL:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_INVERSE_ESSENTIAL:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_SYMMETRIC:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_ASYMMETRIC:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_REFLEXIVE:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_IRREFLEXIVE:
			case OMLTPackage.ENTITY_RELATIONSHIP__IS_TRANSITIVE:
