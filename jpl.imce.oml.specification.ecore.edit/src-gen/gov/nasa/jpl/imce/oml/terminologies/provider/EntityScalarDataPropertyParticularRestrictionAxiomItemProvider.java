...
import gov.nasa.jpl.imce.oml.terminologies.EntityScalarDataPropertyParticularRestrictionAxiom;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.EntityScalarDataPropertyParticularRestrictionAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityScalarDataPropertyParticularRestrictionAxiomItemProvider extends EntityScalarDataPropertyRestrictionAxiomItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_SCALAR_DATA_PROPERTY_PARTICULAR_RESTRICTION_AXIOM__LITERAL_VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntityScalarDataPropertyParticularRestrictionAxiom.class)) {
			case OMLTPackage.ENTITY_SCALAR_DATA_PROPERTY_PARTICULAR_RESTRICTION_AXIOM__LITERAL_VALUE:
