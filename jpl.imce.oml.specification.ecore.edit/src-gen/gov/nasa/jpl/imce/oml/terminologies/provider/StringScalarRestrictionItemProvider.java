...
import gov.nasa.jpl.imce.oml.terminologies.StringScalarRestriction;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.StringScalarRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringScalarRestrictionItemProvider extends RestrictedDataRangeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.STRING_SCALAR_RESTRICTION__LENGTH,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.STRING_SCALAR_RESTRICTION__MIN_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.STRING_SCALAR_RESTRICTION__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.STRING_SCALAR_RESTRICTION__PATTERN,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringScalarRestriction.class)) {
			case OMLTPackage.STRING_SCALAR_RESTRICTION__LENGTH:
			case OMLTPackage.STRING_SCALAR_RESTRICTION__MIN_LENGTH:
			case OMLTPackage.STRING_SCALAR_RESTRICTION__MAX_LENGTH:
			case OMLTPackage.STRING_SCALAR_RESTRICTION__PATTERN:
