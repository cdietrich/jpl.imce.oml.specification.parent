...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.EntityScalarDataProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityScalarDataPropertyItemProvider extends DataRelationshipItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.DATA_RELATIONSHIP_FROM_ENTITY__DOMAIN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.DATA_RELATIONSHIP_FROM_ENTITY__IS_IDENTITY_CRITERIA,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.DATA_RELATIONSHIP_TO_SCALAR__RANGE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EntityScalarDataProperty.class)) {
			case OMLTPackage.ENTITY_SCALAR_DATA_PROPERTY__IS_IDENTITY_CRITERIA:
