...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.TerminologyBoxAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminologyBoxAxiomItemProvider extends TerminologyAxiomItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TerminologyBoxAxiomItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.TERMINOLOGY_BOX_AXIOM__TBOX,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((TerminologyBoxAxiom)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_TerminologyBoxAxiom_type") :
			getString("_UI_TerminologyBoxAxiom_type") + " " + label;
	}
