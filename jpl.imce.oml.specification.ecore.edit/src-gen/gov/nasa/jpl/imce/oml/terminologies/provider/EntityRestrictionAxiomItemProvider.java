...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.terminologies.EntityRestrictionAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RESTRICTION_AXIOM__RESTRICTED_RELATION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RESTRICTION_AXIOM__RESTRICTED_RANGE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLTPackage.Literals.ENTITY_RESTRICTION_AXIOM__RESTRICTED_DOMAIN,
				 true,
				 false,
				 true,
				 null,
