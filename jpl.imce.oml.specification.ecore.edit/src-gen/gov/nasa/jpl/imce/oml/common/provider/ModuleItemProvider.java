...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.common.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLCPackage.Literals.MODULE__IRI,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OMLCPackage.Literals.MODULE__ANNOTATIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Module.class)) {
			case OMLCPackage.MODULE__IRI:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case OMLCPackage.MODULE__ANNOTATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OMLCPackage.Literals.MODULE__ANNOTATIONS,
				 OMLCFactory.eINSTANCE.createAnnotation()));
	}
