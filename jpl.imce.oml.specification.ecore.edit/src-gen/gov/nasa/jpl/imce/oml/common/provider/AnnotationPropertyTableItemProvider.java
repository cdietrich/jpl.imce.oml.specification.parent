...
public class AnnotationPropertyTableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLCPackage.Literals.ANNOTATION_PROPERTY_TABLE__KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OMLCPackage.Literals.ANNOTATION_PROPERTY_TABLE__VALUE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Map.Entry.class)) {
			case OMLCPackage.ANNOTATION_PROPERTY_TABLE__VALUE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OMLCPackage.Literals.ANNOTATION_PROPERTY_TABLE__VALUE,
				 OMLCFactory.eINSTANCE.createAnnotationEntry()));
	}
