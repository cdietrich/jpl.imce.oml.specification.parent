...
import gov.nasa.jpl.imce.oml.common.AnnotationEntry;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.common.AnnotationEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationEntryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLCPackage.Literals.ANNOTATION_ENTRY__MODULE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLCPackage.Literals.ANNOTATION_ENTRY__SUBJECT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLCPackage.Literals.ANNOTATION_ENTRY__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((AnnotationEntry)object).getValue();
		return label == null || label.length() == 0 ?
			getString("_UI_AnnotationEntry_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AnnotationEntry.class)) {
			case OMLCPackage.ANNOTATION_ENTRY__VALUE:
