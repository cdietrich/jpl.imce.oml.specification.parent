...
import gov.nasa.jpl.imce.oml.descriptions.ReifiedRelationshipInstanceDomain;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.descriptions.ReifiedRelationshipInstanceDomain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReifiedRelationshipInstanceDomainItemProvider extends TerminologyInstanceAssertionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ReifiedRelationshipInstanceDomainItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.REIFIED_RELATIONSHIP_INSTANCE_DOMAIN__DESCRIPTION_BOX,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.REIFIED_RELATIONSHIP_INSTANCE_DOMAIN__REIFIED_RELATIONSHIP_INSTANCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.REIFIED_RELATIONSHIP_INSTANCE_DOMAIN__DOMAIN,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ReifiedRelationshipInstanceDomain.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReifiedRelationshipInstanceDomain"));
	}
