...
import gov.nasa.jpl.imce.oml.descriptions.ConceptInstance;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.descriptions.ConceptInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.CONCEPT_INSTANCE__DESCRIPTION_BOX,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.CONCEPT_INSTANCE__SINGLETON_CONCEPT_CLASSIFIER,
				 true,
				 false,
				 true,
				 null,
