...
import gov.nasa.jpl.imce.oml.descriptions.DescriptionBoxRefinement;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.descriptions.DescriptionBoxRefinement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.DESCRIPTION_BOX_REFINEMENT__REFINING_DESCRIPTION_BOX,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.DESCRIPTION_BOX_REFINEMENT__REFINED_DESCRIPTION_BOX,
				 true,
				 false,
				 true,
				 null,
