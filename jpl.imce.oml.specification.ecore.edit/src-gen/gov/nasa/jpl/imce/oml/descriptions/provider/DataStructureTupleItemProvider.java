...
import gov.nasa.jpl.imce.oml.descriptions.DataStructureTuple;
...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.descriptions.DataStructureTuple} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.DATA_STRUCTURE_TUPLE__STRUCTURED_DATA_PROPERTY_VALUE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLDPackage.Literals.DATA_STRUCTURE_TUPLE__DATA_STRUCTURE_TYPE,
				 true,
				 false,
				 true,
				 null,
