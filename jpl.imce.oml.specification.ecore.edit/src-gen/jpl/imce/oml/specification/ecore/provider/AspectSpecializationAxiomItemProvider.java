...
/**
 * This is the item provider adapter for a {@link jpl.imce.oml.specification.ecore.AspectSpecializationAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLPackage.Literals.ASPECT_SPECIALIZATION_AXIOM__SUB_ENTITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLPackage.Literals.ASPECT_SPECIALIZATION_AXIOM__SUPER_ASPECT,
				 true,
				 false,
				 true,
				 null,
