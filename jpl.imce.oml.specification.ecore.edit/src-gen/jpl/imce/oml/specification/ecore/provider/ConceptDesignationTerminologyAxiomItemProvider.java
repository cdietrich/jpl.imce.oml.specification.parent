...
/**
 * This is the item provider adapter for a {@link jpl.imce.oml.specification.ecore.ConceptDesignationTerminologyAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcorePackage.eINSTANCE.getConceptDesignationTerminologyAxiom_DesignatedTerminology(),
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcorePackage.eINSTANCE.getConceptDesignationTerminologyAxiom_DesignatedConcept(),
				 true,
				 false,
				 true,
				 null,
