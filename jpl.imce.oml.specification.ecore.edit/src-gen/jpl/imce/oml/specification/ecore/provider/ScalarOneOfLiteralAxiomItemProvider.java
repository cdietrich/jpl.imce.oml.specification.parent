...
/**
 * This is the item provider adapter for a {@link jpl.imce.oml.specification.ecore.ScalarOneOfLiteralAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLPackage.Literals.SCALAR_ONE_OF_LITERAL_AXIOM__AXIOM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OMLPackage.Literals.SCALAR_ONE_OF_LITERAL_AXIOM__VALUE,
				 true,
				 false,
				 false,
